...
def populate_stats():
    ...
    events = requests.get(f'http://34.122.125.217/storage/buy?timestamp={last_updated}')
    ...
    events = requests.get(f'http://34.122.125.217/storage/sell?timestamp={last_updated}')
